...
;
;	Bump Light + Bump Specular + FallOff
;
...
;====================================
; Shader
Local tShader%=xLoadFXFile("..\..\Materials\Bump Light + Bump Specular + FallOff.fx")
;====================================
...
xSetEffectVector tModel,	"LightClr",1,.8,.6
...
Repeat
		...
		xPositionEntity tLightSpr,Sin(time*.05)*30,Abs(Sin(time*.04)*25)+5,Sin(time*.05)*30
		;====================================
