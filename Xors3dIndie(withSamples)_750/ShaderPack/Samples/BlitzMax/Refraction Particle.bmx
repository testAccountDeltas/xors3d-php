...
'====================================
' Shader
Local tShader% = xLoadFXFile("..\..\Materials\Refraction Particle.fx")
'====================================


'====================================
' Model
Local tModel% = xCreatePoly(1, 0)
xScaleEntity tModel, 30, 30, 30
xUpdateNormals tModel

Local tTextureDiffuse% = xLoadTexture("..\Media\Spark.png")
Local tTextureNormalS% = xLoadTexture("..\Media\Fire_NormalS.png")
Local tTextureNormalF% = xLoadTexture("..\Media\Fire_NormalF.png")
