...
xCreateLog(LOG_HTML, LOG_INFO, "Local Body.html")
...
xEntityBodyLocalPosition(box, 0, 1, 0)
xEntityBodyLocalScale(box, 1, 0.5, 1)
...
While Not xKeyDown(KEY_ESCAPE)
	...
	xUpdateWorld()
	xRenderWorld(1, True)
	xText 10, 10, "Press <Space> to apply impulse"
	xFlip()	
Wend
End
