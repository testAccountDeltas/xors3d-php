...
xCreateLog(LOG_HTML, LOG_INFO, "Damping - Linear.html")
...
xPositionEntity(cubeRed, -4, 15, -4)
...
xEntitySetDamping(cubeRed, 0.75, 0.0)

Global cubeGreen = xCreateCube()
xPositionEntity(cubeGreen, 4, 15, 4)
...
xEntitySetDamping(cubeGreen, 0.0, 0.0)
...
Function PrintValues()
	...
	xText( xProjectedX(), xProjectedY() - 20, xEntityGetLinearDamping(cubeRed))
	xCameraProject(camera, xEntityX(cubeGreen, True), xEntityY(cubeGreen, True) + 2.5, xEntityZ(cubeGreen, True))
	xText( xProjectedX(), xProjectedY() - 20, xEntityGetLinearDamping(cubeGreen))
End Function
