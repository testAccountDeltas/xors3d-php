;*******************************************************************
;*                                                                 *
;* Xors3D Engine. Mesh intersect sample, (c) 2009 Xors3D Team      *
;* www: http://xors3d.com                                          *
...
While Not xKeyDown(1) Or xWinMessage("WM_CLOSE")
	...
	; Move cube
	If xKeyDown(KEY_W) Then xMoveEntity cube,  0.0,  0.1, 0.0
	If xKeyDown(KEY_S) Then xMoveEntity cube,  0.0, -0.1, 0.0
	If xKeyDown(KEY_A) Then xMoveEntity cube, -0.1,  0.0, 0.0
	If xKeyDown(KEY_D) Then xMoveEntity cube,  0.1,  0.0, 0.0
