...
While Not xKeyDown(xKEY_ESCAPE)
	...
	' animation switch
	If xKeyHit(xKEY_1) Then xAnimate hazar, 2, 0.1, animIndle ; curAnimation = animIndle
	If xKeyHit(xKEY_2) Then xAnimate hazar, 1, 1.0, animRun ; curAnimation = animRun
	If xKeyHit(xKEY_3) Then xAnimate hazar, 1, 1.0, animAttack ; curAnimation = animAttack
	If xKeyHit(xKEY_4) Then xAnimate hazar, 3, 1.0, animDeath ; curAnimation = animDeath
