...
- **Погода**: динамическая смена ясно / **дождь** / **снег** (снег — в холодных
  ...
  затягивает пасмурная дымка и появляется мокрый блеск, снег со временем
  **ложится** на поверхности (верхушки блоков белеют) и тает, когда распогодится.
  Переключается в настройках («Weather»).
