...
- **Печка**: ставится, открывается на **E** — меню плавки (песок→стекло, булыжник→
  камень, бревно→уголь, земля→кирпич); каждая плавка тратит 1 топливо (уголь/дерево/доски).
...
- **Миникарта**: в правом верхнем углу — вид сверху на поверхность вокруг игрока
  (цвет по типу блока, отметка игрока, север сверху). Отключается настройкой «Minimap».
- **Сон**: ночью рядом с кроватью (красная шерсть) нажми **B** — время
  перематывается до утра.
